...
import DataContext from '../context/DriverdataContext';
        ...
        <div className="row vh-100 align-items-center justify-content-center">
          <div className="col-lg-6">
            ...
            >
              ...
              <HomeLink to="/driver">Закінчити</HomeLink>
            </div>
          </div>
        </div>
      </div>
...
// const Result = () => {
//   const { showResult, quizs, marks, startOver, setQuizCompleted } =
...
//               <HomeLink to="/driver" onClick={handleFinishTest}>
//                 Закінчити
//               </HomeLink>
//             </div>
//           </div>
